...
class TwoPairsCombinationTest {
    ...
    void testTwoPairsCombination_PositiveCases(final List<Card> inputCards, final List<Card> combinationCards) {
        final Option<List<Card>> result = new TwoPairsCombination().isCombinationValid(inputCards);
        assertEquals(combinationCards, result.get(), "Not a Two Pairs result, input cards " + inputCards);
    }
